...
function showSuccessMessage(message) {
  ...
  /*
  new Notification('Subscription granted!');
  */
...
function storePushSub() {
  ...
  navigator.serviceWorker.ready
    ...
    .then(function (pushSubscription) {
      ...
      var vapidPublicKey = 'BM7PSyvdfXZUFZD47E3zPqDqw-INAQiy9hnKxJYramR76iJc2Onkf2wbKZBJ4SRJhMA7zehnyGV45Joauo__lhs';
      return swreg.pushManager.subscribe({
        userVisibleOnly: true,
        applicationServerKey: helpers.urlBase64ToUint8Array(vapidPublicKey)
      });
    })
    .then(function (newPushSubscription) {
      console.log('New Push Subscription', newPushSubscription);
      return postSubscription(newPushSubscription);
    })
    .then(function (res) {
      console.log('after Post subscription', res);
      if (res.ok) {
        res.json()
          .then(function (body) {
